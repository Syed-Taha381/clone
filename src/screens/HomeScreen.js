...
import { View, StyleSheet, Text, Dimensions, ScrollView, Image, FlatList } from 'react-native';
...
const Homescreen = () => {
    ...
    const checkPermission = async () => {
        const hasPremission = await Location.requestForegroundPermissionsAsync()
        if (hasPremission.status === 'granted') {
